...
class Preprocessor:
    ...
    **************************************************************************
    ...
    def is_null_present(self, data):
        ...
        *return: Returns a Boolean value. True if null values are present in the DataFrame, False if the are not present.
        *
        *who           when           version   change (include bug# if apply)
        *---------     -----------    -------   ------------------------------
        *D. Rawlins    12-JAN-2024       1.0     initial creation
        ...
        *   data:
        ...
        try:
            ...
            if(self.null_present): #write the logs to see which columns have null values
                ...
                dataframe_with_null.to_csv(self.data_path+'_validation/'+'null_values.csv') #storting the null column information to file
            self.logger.info('Start of finding missing values...')
    ...
    def feature_encoding(self, data):
        ...
        *description: method to encode features
        *return: none
        *
        *who           when           version   change (include bug# if apply)
        *---------     -----------    -------   ------------------------------
        ...
        *   data:
        ...
        try:
            ...
            self.logger.exception('Exception raised while encoding feature:'+str(e))
            raise Exception()
    ...
    def final_predictset(self, data):
        ...
        *   label_name:
        ...
        try:
            ...
            self.logger.info('ValueError raised while building final predictset')
            raise ValueError
        except KeyError:
            self.logger.info('KeyError raised while building final predictset')
            raise KeyError
        except Exception as e:
            self.logger.info('Exception raised while building final predictset: %s' %e)
            raise e
    ...
    def preprocess_trainset(self):
        ...
        *   none:
        ...
        try:
            ...
            #if missing values are there, replace them appropiatelly
            if(is_null_present):
