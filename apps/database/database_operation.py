...
class DatabaseOperation:
    ...
    **************************************************************************
        ...
        try:
            ...
            if c.fetchone()[0] == 1:
                ...
                for key in column_names.keys():
                    ...
                    #in tyr block we check if the table exits, if yes the add columns to the table
                    # else in except block we will create the table --training_raw_data_t
                    try:
    ...
    def insert_data(self, database_name, table_name):
        """
        *method: insert_data
        *description: method to insert data into database table
        *return: none
        *
        *who           when           version   change (include bug# if apply)
        *---------     -----------    -------   ------------------------------
    ...
    def export_csv(self, database_name, table_name):
        """
        *method: export_csv
        *description: method to export select data from table in export into csv
        *return: none
        *
        *who           when           version   change (include bug# if apply)
        *---------     -----------    -------   ------------------------------
